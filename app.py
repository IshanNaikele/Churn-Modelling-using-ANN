...
input_data = pd.DataFrame({
    ...
    'Geography':[geography] # This is correct
})
 
# Fix: Use 'Geography' with correct casing and extract the scalar value
geo_encoded = one_hot_encoder_geography.transform([[input_data['Geography'].iloc[0]]])
